  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          type: "p",
          text: "The public, NDA-safe evidence is on pickleballtournaments.com: the updated home page, search and detail pages, plus the Admin area. My project manager put it in writing.",
        },
        {
          type: "quote",
          text: "A major contributor to the updated pickleballtournaments.com home page, search, and detail pages. He has also done exceptional work on our Admin area.",
          by: "Patrick Gaughan, Project Manager, Pickleball.com",
        },
        {
          type: "p",
