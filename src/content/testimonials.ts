...
export const testimonials: Testimonial[] = [
  {
    ...
    lang: "en",
    featured: true,
    pull: "a rare blend of strategic thinking, user-centered design, and pixel-perfect execution",
  ...
  },
  {
    ...
    lang: "en",
    featured: true,
    pull: "a major contributor to the updated pickleballtournaments.com home page, search, and detail pages",
  ...
  },
  {
    ...
    lang: "en",
    featured: true,
    pull: "One of Aydin's standout qualities is his excellent communication and teamwork skills.",
    text: "We at Bild had the pleasure of cooperating with Aydin Tokur for almost two years. I highly recommend Aydin for his exceptional skills and contributions as a UX/UI designer. As a colleague and team member, Aydin consistently demonstrated professionalism, creativity, and a strong commitment to delivering outstanding design solutions.\n\nOne of Aydin's standout qualities is his excellent communication and teamwork skills.",
  },
  {
    name: "Ivo Lasic",
    role: "UX/UI Designer",
    ...
    lang: "en",
    featured: true,
    pull: "He appreciates good beer too 🙂",
