...
export function mountGui(GUI, { params, state, info, actions }) {
  ...
  text
    // Only the stacks the site actually loads — anything else silently
    // falls back to system sans and looks like a bug.
    .add(params, "textFont", { display: params.nameFont, mono: params.idxFont })
    .name("family")
