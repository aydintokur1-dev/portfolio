...
export const bio: string[] = [
  ...
  "The combination is the point. Building keeps my design honest: I know what breaks and where the real constraints sit before a file ever leaves Figma, so nothing I hand over dies at handoff.",
